        ...
        <section className="py-2">
            <div className="max-w-3xl mx-auto mt-8 space-y-4 md:mt-16">
                <div
                    ...
                    <button onClick={() => setOpenFavorite(!openFavorite)} type="button" id="question1" data-state="closed" className="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                    ...
                    {!openFavorite && <div>
                        <div id="answer1" className="grid grid-cols-2 gap-4 px-4 pb-5 sm:px-6 sm:pb-6">
